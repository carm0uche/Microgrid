...
def graphique(profile):
    ...
    plt.xticks(np.linspace(0, 51, num=12), labels=["Jan", "Fév", "Mar", "Avr", "Mai", "Juin", "Juil", "Août", "Sep", "Oct", "Nov", "Déc"])
    plt.grid(True, linestyle="--", alpha=0.6)
    plt.show()

    # Graphique des niveaux de batterie
    fig, ax_batt = plt.subplots(figsize=(12, 4))
...
graphique(simulation([6, 1, 2, 1, 2000])[2])
